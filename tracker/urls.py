...
from phermes.tracker.views import list_markersimg
from phermes.tracker.views import current_geos
...
urlpatterns = patterns('',
    ...
    (r'^listmarkersimg/$', list_markersimg),   # get list of devices
    (r'^currentgeos/$', current_geos),         # get current geo info
)